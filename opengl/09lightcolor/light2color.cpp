...
int main() {
    ...
    Shader lightShader("09/shader2/light.vert", "09/shader2/light.frag");
    Shader boxShader("09/shader2/box.vert", "09/shader2/box.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        projection = glm::perspective(glm::radians(camera.Zoom), (float) SCREEN_WIDTH / (float) SCREEN_HEIGHT, 0.1f,
                                      100.0f);
