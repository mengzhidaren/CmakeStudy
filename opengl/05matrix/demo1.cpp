...
//GLAD是用来管理OpenGL的函数指针的 所以在调用任何OpenGL的函数之前我们需要初始化GLAD。
    int main() {
        ...
        Shader outShader("05\\shader\\vertex.vert", "05\\shader\\fragment.frag");
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            trans = rotate(trans, radians(time * 10), vec3(0.0, 0.0, 1.0));
            glUniformMatrix4fv(glGetUniformLocation(outShader.ID, "tansform"), 1, GL_FALSE, glm::value_ptr(trans));
